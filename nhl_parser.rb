...
class NHLParser
  def initialize file = nil
    if file==nil
      #page = "http://www.nhl.com/ice/playerstats.htm#?navid=nav-sts-indiv"
      page = "http://www.nhl.com/ice/app?service=page&page=playerstats&fetchKey=20112ALLAASAll&viewName=summary&sort=points&pg=1"
    else
      page = file
    end
